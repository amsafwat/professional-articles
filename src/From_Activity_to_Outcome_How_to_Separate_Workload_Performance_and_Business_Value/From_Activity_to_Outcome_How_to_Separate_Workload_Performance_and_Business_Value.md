...
![Gemini_Generated_Image_9p11os9p11os9p11](images\Gemini_Generated_Image_9p11os9p11os9p11.png)
...
```mermaid
flowchart TD
    A[Business or customer need] --> B[Activity and workload]
    B --> C[Output delivered]
    C --> D[Outcome observed]
    D --> E[Value assessed]
```
